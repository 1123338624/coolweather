...
queryWeatherInfo(weatherCode);
Log.d("WeatherActivity", "onFinish,countyCode");
}
}
} 
else if ("weatherCode".equals(type)) 
{
Log.d("WeatherActivity", "onFinish,weatherCode");	
// 处理服务器返回的天气信息
...
{
showWeather();
Log.d("WeatherActivity", "onFinish,weatherCode,showWeather");	
}
});
}
}
	...
	*/
	...
	Log.d("WeatherActivity", "showWeather");		
	SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
